...
def test_empty_file():
    ...
    string_xml = open_file("empty_xml.xml")
    with pytest.raises(InputError):
        check_xml_empty(string_xml)

def test_refernce_number():

    string_xml = open_file("example_invoice_no_ref_number.xml") #parse_xml_file("example_invoice_no_ref_number.xml")
...
def test_date_syntax_number():
    ...
    string_xml = open_file("example_invoice_wrong_date_syntax.xml")
...
def test_check_currency_Code():
    ...
    string_xml = open_file("example_invoice_currency_code.xml")
...
def test_check_if_buyer_seller_address_exists():
    ...
    string_xml = open_file("example_invoice_no_address.xml")
...
def test_check_base_amount_and_percentage():
    ...
    string_xml = open_file("example_invoice_invalid_percentage_baseamount.xml")
...
def test_check_gross_net_amount():
    ...
    string_xml = open_file("example_invoice_invalid_gross_net_price.xml")
...
def test_valid_invoic():
    ...
    string_xml = open_file("exmaple_invoice.xml")
    # Valid invoice
